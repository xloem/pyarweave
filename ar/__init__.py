...
HASH_SZ = 256
RSA_SIGN_ALG = 'rsa'
RSA_PRIV_KEY_SZ = 4096
ECDSA_SIGN_ALG = 'ecdsa'
ECDSA_TYPE_BYTE = b'\x02'
EDDSA_SIGN_ALG = 'eddsa'
EDDSA_TYPE_BYTE = b'\x03'
RSA_KEY_TYPE = [RSA_SIGN_ALG, 65537]
ECDSA_KEY_TYPE = [ECDSA_SIGN_ALG, 'secp256k1']
DEFAULT_KEY_TYPE = RSA_KEY_TYPE
RSA_BLOCK_SIG_SIZE = 512
ECDSA_PUB_KEY_SIZE = 33
ECDSA_SIG_SIZE = 65
